...
void function() {
    // Variables
    let subtitleElement = document.getElementById("subtitle") as HTMLHeadingElement;
    let index = 0;
    let subtitles = [
...
void async function() {
    ...
    let buttonDay = document.getElementById("status-day") as HTMLButtonElement;
    let buttonWeek = document.getElementById("status-week") as HTMLButtonElement;
    let buttonMonth = document.getElementById("status-month") as HTMLButtonElement;
    let latencyElement = document.getElementById("latency") as HTMLCanvasElement;
